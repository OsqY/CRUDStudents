 ...
 * @author nbmmll nnnnn
 */
public class VerCalificacionesSegundoParcial extends javax.swing.JPanel {

    public VerCalificacionesSegundoParcial() {
        initComponents();
        initStyles();
    }
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        try {
            ...
            int notaGeneral = dao.calcularPromedioPorParcial(id, 2);
            ...
            List<Notas> notas = dao.listarNotas(id, 2);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (tablaNotas.getSelectedRow() < 0) {
            ...
            try {
                DAOEstudiante dao = new DAOEstudianteImpl();
                MenuPrincipalJFrame.mostrarJPanel(new SegundoParcialJPanel(dao.buscarNotas(id, 2)));
