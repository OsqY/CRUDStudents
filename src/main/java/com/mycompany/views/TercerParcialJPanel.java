...
public class TercerParcialJPanel extends javax.swing.JPanel {

    boolean edicion = false;
    Notas editarNota = null;

    public TercerParcialJPanel() {
        initComponents();
        initStyles();
    }

    public TercerParcialJPanel(Notas nota) {
        initComponents();
        edicion = true;
        editarNota = nota;
        initStyles();
    ...
    private void initComponents() {
        ...
        materia1Label.setText("Materia 13");
        ...
        materia2Label.setText("Materia 23");
        ...
        materia3Label.setText("Materia 33");
        ...
        materia4Label.setText("Materia 43");
        ...
        materia7Label.setText("Materia 73");
        ...
        materia6Label.setText("Materia 63");

        materia5Label.setForeground(new java.awt.Color(255, 255, 255));
        materia5Label.setText("Materia 53");
        ...
        materia8Label.setText("Materia 83");
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        notasEstudiantes.setParcial(3);
        try {
            if (!edicion) {
                dao.subirNotas(notasEstudiantes);
                javax.swing.JOptionPane.showMessageDialog(this, "Subidas las notas del tercer parcial al estudiante con identidad: " + id + " exitosamente. \n", "AVISO", javax.swing.JOptionPane.INFORMATION_MESSAGE);
                materia1Txt.setText("");
                materia2Txt.setText("");
                materia3Txt.setText("");
                materia4Txt.setText("");
                ...
                javax.swing.JOptionPane.showMessageDialog(this, "Editadas las notas del tercer parcial al estudiante con identidad: " + id + " exitosamente. \n", "AVISO", javax.swing.JOptionPane.INFORMATION_MESSAGE);
                materia1Txt.setText("");
                materia2Txt.setText("");
                materia3Txt.setText("");
                materia4Txt.setText("");
