...
public class SegundoParcialJPanel extends javax.swing.JPanel {

    boolean edicion = false;
    Notas editarNota = null;

    public SegundoParcialJPanel() {
        initComponents();
        initStyles();
    }

    public SegundoParcialJPanel(Notas nota) {
        initComponents();
        edicion = true;
        editarNota = nota;
        initStyles();
    ...
    private void initComponents() {
        ...
        materia1Label.setText("Materia 12");
        ...
        materia2Label.setText("Materia 22");
        ...
        materia3Label.setText("Materia 32");
        ...
        materia4Label.setText("Materia 42");
        ...
        materia7Label.setText("Materia 72");
        ...
        materia6Label.setText("Materia 62");

        materia5Label.setForeground(new java.awt.Color(255, 255, 255));
        materia5Label.setText("Materia 52");
        ...
        materia8Label.setText("Materia 82");
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        notasEstudiantes.setParcial(2);
        try {
            if (!edicion) {
                dao.subirNotas(notasEstudiantes);
                javax.swing.JOptionPane.showMessageDialog(this, "Subidas las notas del segundo parcial al estudiante con identidad: " + id + " exitosamente. \n", "AVISO", javax.swing.JOptionPane.INFORMATION_MESSAGE);
                materia1Txt.setText("");
                materia2Txt.setText("");
                materia3Txt.setText("");
                materia4Txt.setText("");
                ...
                javax.swing.JOptionPane.showMessageDialog(this, "Editadas las notas del segundo parcial al estudiante con identidad: " + id + " exitosamente. \n", "AVISO", javax.swing.JOptionPane.INFORMATION_MESSAGE);
                materia1Txt.setText("");
                materia2Txt.setText("");
                materia3Txt.setText("");
                materia4Txt.setText("");
