...
public class PrimerParcialJPanel extends javax.swing.JPanel {

    boolean edicion = false;
    Notas editarNota = null;

    public PrimerParcialJPanel() {
        initComponents();
        initStyles();
    }

    public PrimerParcialJPanel(Notas nota) {
        initComponents();
        edicion = true;
        editarNota = nota;
        initStyles();
    ...
    private void initStyles() {
        ...
        if (edicion) {
            titulo1.setText("Notas Primer Parcial (EDICIÓN)");
    ...
    private void initComponents() {
        ...
        titulo1.setText("Notas Primer Parcial");

        materia1Label.setForeground(new java.awt.Color(255, 255, 255));
        materia1Label.setText("Materia 1");
        ...
        materia2Label.setText("Materia 2");
        ...
        materia3Label.setText("Materia 3");
        ...
        materia4Label.setText("Materia 4");
        ...
        materia7Label.setText("Materia 7");
        ...
        materia6Label.setText("Materia 6");

        materia5Label.setForeground(new java.awt.Color(255, 255, 255));
        materia5Label.setText("Materia 5");
        ...
        materia8Label.setText("Materia 8");
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        notasEstudiantes.setParcial(1);
        try {
            if (!edicion) {
                dao.subirNotas(notasEstudiantes);
                javax.swing.JOptionPane.showMessageDialog(this, "Subidas las notas del primer parcial al estudiante con identidad: " + id + " exitosamente. \n", "AVISO", javax.swing.JOptionPane.INFORMATION_MESSAGE);
                materia1Txt.setText("");
                materia2Txt.setText("");
                materia3Txt.setText("");
                materia4Txt.setText("");
                ...
                javax.swing.JOptionPane.showMessageDialog(this, "Editadas las notas del primer parcial al estudiante con identidad: " + id + " exitosamente. \n", "AVISO", javax.swing.JOptionPane.INFORMATION_MESSAGE);
                materia1Txt.setText("");
                materia2Txt.setText("");
                materia3Txt.setText("");
                materia4Txt.setText("");
