 ...
 * @author nbmmll nnnnn
 */
public class VerCalificacionesCuartoParcial extends javax.swing.JPanel {

    public VerCalificacionesCuartoParcial() {
        initComponents();
        initStyles();
    }
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        try {
            ...
            int notaGeneral = dao.calcularPromedioPorParcial(id, 4);
            ...
            List<Notas> notas = dao.listarNotas(id, 4);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (tablaNotas.getSelectedRow() < 0) {
            ...
            try {
                DAOEstudiante dao = new DAOEstudianteImpl();
                MenuPrincipalJFrame.mostrarJPanel(new CuartoParcialJPanel(dao.buscarNotas(id, 4)));
